...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0754R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0754R.C0755drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0754R.C0756id.icon);
        this.mSmallLabel = (TextView) findViewById(C0754R.C0756id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0754R.C0756id.largeLabel);
    }
