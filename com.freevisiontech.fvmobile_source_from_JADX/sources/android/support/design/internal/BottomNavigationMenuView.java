...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.mInactiveItemMaxWidth = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = res.getDimensionPixelSize(C0754R.dimen.design_bottom_navigation_height);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = View.MeasureSpec.makeMeasureSpec(this.mItemHeight, C1907C.ENCODING_PCM_32BIT);
        ...
        for (int i5 = 0; i5 < count; i5++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(View.MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i5], C1907C.ENCODING_PCM_32BIT), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, View.MeasureSpec.makeMeasureSpec(totalWidth, C1907C.ENCODING_PCM_32BIT), 0), View.resolveSizeAndState(this.mItemHeight, heightSpec, 0));
    }
