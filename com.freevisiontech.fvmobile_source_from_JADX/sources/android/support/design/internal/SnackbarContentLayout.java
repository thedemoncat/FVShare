...
public class SnackbarContentLayout extends LinearLayout implements BaseTransientBottomBar.ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0754R.styleable.SnackbarLayout);
        this.mMaxWidth = a.getDimensionPixelSize(C0754R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C0754R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0754R.C0756id.snackbar_text);
        this.mActionView = (Button) findViewById(C0754R.C0756id.snackbar_action);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mMaxWidth > 0 && getMeasuredWidth() > this.mMaxWidth) {
            widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mMaxWidth, C1907C.ENCODING_PCM_32BIT);
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
        int multiLineVPadding = getResources().getDimensionPixelSize(C0754R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0754R.dimen.design_snackbar_padding_vertical);
