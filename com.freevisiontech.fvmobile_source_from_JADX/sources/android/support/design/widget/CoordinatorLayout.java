...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    static {
        ...
        L_0x000d:
            ...
            android.support.design.widget.CoordinatorLayout$ViewElevationComparator r1 = new android.support.design.widget.CoordinatorLayout$ViewElevationComparator
            r1.<init>()
        ...
        L_0x001c:
            ...
            r1.<init>()
            sConstructors = r1
            android.support.v4.util.Pools$SynchronizedPool r1 = new android.support.v4.util.Pools$SynchronizedPool
            r2 = 12
            r1.<init>(r2)
            sRectPool = r1
            return
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0754R.styleable.CoordinatorLayout, defStyleAttr, C0754R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0754R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0754R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0754R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0754R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0754R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0754R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0754R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0754R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0754R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0754R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0754R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
