...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(C0754R.layout.design_layout_snackbar_include, parent, false);
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child.getLayoutParams().width == -1) {
                    child.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), C1907C.ENCODING_PCM_32BIT));
                }
            }
        }
    }
