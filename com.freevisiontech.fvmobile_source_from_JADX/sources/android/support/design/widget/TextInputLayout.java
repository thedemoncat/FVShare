...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0754R.styleable.TextInputLayout, defStyleAttr, C0754R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0754R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0754R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0754R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0754R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0754R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0754R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0754R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0754R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0754R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0754R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0754R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0754R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0754R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0754R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0754R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0754R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0754R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0754R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0754R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0754R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
        }
        a.recycle();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0754R.C0756id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0777R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0777R.color.error_color_material));
                }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0754R.C0756id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0777R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0777R.color.error_color_material));
                }
    ...
    public void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0754R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
    ...
    private void updateEditTextBackground() {
        ...
        if (this.mEditText != null && (editTextBackground = this.mEditText.getBackground()) != null) {
            ensureBackgroundDrawableStateWorkaround();
            if (DrawableUtils.canSafelyMutateDrawable(editTextBackground)) {
                editTextBackground = editTextBackground.mutate();
            }
            if (this.mErrorShown && this.mErrorView != null) {
                editTextBackground.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(this.mErrorView.getCurrentTextColor(), PorterDuff.Mode.SRC_IN));
            } else if (!this.mCounterOverflowed || this.mCounterView == null) {
                DrawableCompat.clearColorFilter(editTextBackground);
                this.mEditText.refreshDrawableState();
            } else {
                editTextBackground.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(this.mCounterView.getCurrentTextColor(), PorterDuff.Mode.SRC_IN));
            }
        }
    }
    ...
    private void ensureBackgroundDrawableStateWorkaround() {
        ...
        if ((sdk == 21 || sdk == 22) && (bg = this.mEditText.getBackground()) != null && !this.mHasReconstructedEditTextBackground) {
        ...
        if (this.mEditText != null) {
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0754R.layout.design_text_input_password_icon, this.mInputFrame, false);
