...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x0046 A[Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }] */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x005b A[SYNTHETIC, Splitter:B:16:0x005b] */
    @android.support.annotation.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.support.graphics.drawable.AnimatedVectorDrawableCompat create(@android.support.annotation.NonNull android.content.Context r9, @android.support.annotation.DrawableRes int r10) {
        /*
            r8 = 2
            ...
            android.graphics.drawable.Drawable r6 = android.support.p001v4.content.res.ResourcesCompat.getDrawable(r6, r10, r7)
        ...
        L_0x002f:
            ...
            android.content.res.XmlResourceParser r3 = r4.getXml(r10)     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r3)     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
        L_0x003b:
            int r5 = r3.next()     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            if (r5 == r8) goto L_0x0044
            r6 = 1
            if (r5 != r6) goto L_0x003b
        L_0x0044:
            if (r5 == r8) goto L_0x005b
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            throw r6     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
        L_0x004f:
            r2 = move-exception
        ...
        L_0x0059:
            ...
            goto L_0x002e
        L_0x005b:
            android.content.res.Resources r6 = r9.getResources()     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            android.content.res.Resources$Theme r7 = r9.getTheme()     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            android.support.graphics.drawable.AnimatedVectorDrawableCompat r1 = createFromXmlInner(r9, r6, r3, r0, r7)     // Catch:{ XmlPullParserException -> 0x004f, IOException -> 0x0068 }
            goto L_0x002e
        L_0x0068:
            r2 = move-exception
            java.lang.String r6 = "AnimatedVDCompat"
