...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        ...
        /* renamed from: b */
        private Notification.Builder f1149b;
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f1149b, action));
        }
        ...
        public Notification build() {
            ...
            this.f1149b.setExtras(this.mExtras);
            Notification notification = this.f1149b.build();
