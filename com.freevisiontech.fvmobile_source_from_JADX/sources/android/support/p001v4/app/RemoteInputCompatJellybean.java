...
class RemoteInputCompatJellybean {
    ...
    static RemoteInputCompatBase.RemoteInput fromBundle(Bundle data, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        return factory.build(data.getString(KEY_RESULT_KEY), data.getCharSequence("label"), data.getCharSequenceArray(KEY_CHOICES), data.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), data.getBundle(KEY_EXTRAS), allowedDataTypes);
    }
    ...
    static Bundle getResultsFromIntent(Intent intent) {
        ...
        return (Bundle) clipDataIntent.getExtras().getParcelable(RemoteInput.EXTRA_RESULTS_DATA);
    }
