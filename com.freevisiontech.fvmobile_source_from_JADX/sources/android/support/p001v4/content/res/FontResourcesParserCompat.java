...
public class FontResourcesParserCompat {
    ...
    public static android.support.p001v4.content.res.FontResourcesParserCompat.FamilyResourceEntry parse(org.xmlpull.v1.XmlPullParser r3, android.content.res.Resources r4) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x000a:
            ...
            throw r1
        L_0x0015:
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = readFamilies(r3, r4)
            return r1
        */
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0745R.styleable.FontFamily);
        String authority = array.getString(C0745R.styleable.FontFamily_fontProviderAuthority);
        String providerPackage = array.getString(C0745R.styleable.FontFamily_fontProviderPackage);
        String query = array.getString(C0745R.styleable.FontFamily_fontProviderQuery);
        int certsId = array.getResourceId(C0745R.styleable.FontFamily_fontProviderCerts, 0);
        int strategy = array.getInteger(C0745R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int timeoutMs = array.getInteger(C0745R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0745R.styleable.FontFamilyFont);
        int weight = array.getInt(C0745R.styleable.FontFamilyFont_fontWeight, 400);
        if (1 != array.getInt(C0745R.styleable.FontFamilyFont_fontStyle, 0)) {
            isItalic = false;
        }
        int resourceId = array.getResourceId(C0745R.styleable.FontFamilyFont_font, 0);
        String filename = array.getString(C0745R.styleable.FontFamilyFont_font);
        array.recycle();
        while (parser.next() != 3) {
            skip(parser);
        }
