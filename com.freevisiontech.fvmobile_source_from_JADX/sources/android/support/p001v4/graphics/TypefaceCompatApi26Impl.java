...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r20, @android.support.annotation.Nullable android.os.CancellationSignal r21, @android.support.annotation.NonNull android.support.p001v4.provider.FontsContractCompat.FontInfo[] r22, int r23) {
        /*
            r19 = this;
            r0 = r22
            int r13 = r0.length
        ...
        L_0x0008:
            ...
            android.net.Uri r13 = r4.getUri()     // Catch:{ IOException -> 0x0054 }
            java.lang.String r14 = "r"
            r0 = r21
            android.os.ParcelFileDescriptor r9 = r10.openFileDescriptor(r13, r14, r0)     // Catch:{ IOException -> 0x0054 }
            r14 = 0
            android.graphics.Typeface$Builder r13 = new android.graphics.Typeface$Builder     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            java.io.FileDescriptor r15 = r9.getFileDescriptor()     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            r13.<init>(r15)     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            int r15 = r4.getWeight()     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            android.graphics.Typeface$Builder r13 = r13.setWeight(r15)     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            boolean r15 = r4.isItalic()     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            android.graphics.Typeface$Builder r13 = r13.setItalic(r15)     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            android.graphics.Typeface r13 = r13.build()     // Catch:{ Throwable -> 0x005b, all -> 0x00d6 }
            if (r9 == 0) goto L_0x0007
            if (r14 == 0) goto L_0x0057
            r9.close()     // Catch:{ Throwable -> 0x004f }
            goto L_0x0007
        L_0x004f:
            r15 = move-exception
            r14.addSuppressed(r15)     // Catch:{ IOException -> 0x0054 }
            goto L_0x0007
        L_0x0054:
            r5 = move-exception
            r13 = 0
        ...
        L_0x006a:
            throw r13     // Catch:{ IOException -> 0x0054 }
        L_0x006b:
            r15 = move-exception
            r14.addSuppressed(r15)     // Catch:{ IOException -> 0x0054 }
            goto L_0x006a
        ...
        L_0x0074:
            ...
            r1 = r22
            r2 = r21
            java.util.Map r12 = android.support.p001v4.provider.FontsContractCompat.prepareFontData(r0, r1, r2)
        ...
        L_0x00d6:
            ...
            goto L_0x0063
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.graphics.TypefaceCompatApi26Impl.createFromFontInfo(android.content.Context, android.os.CancellationSignal, android.support.v4.provider.FontsContractCompat$FontInfo[], int):android.graphics.Typeface");
    }
