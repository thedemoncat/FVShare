...
import android.support.p001v4.media.AudioAttributesCompatApi21;
...
public class AudioAttributesCompat {
    ...
    public int getVolumeControlStream() {
        ...
        } else if (Build.VERSION.SDK_INT < 26 || sForceLegacyBehavior || unwrap() == null) {
    ...
    public static class Builder {
        ...
        public AudioAttributesCompat build() {
            if (AudioAttributesCompat.sForceLegacyBehavior || Build.VERSION.SDK_INT < 21) {
                ...
                AudioAttributesCompatApi21.Wrapper unused = aac.mAudioAttributesWrapper = null;
                return aac;
