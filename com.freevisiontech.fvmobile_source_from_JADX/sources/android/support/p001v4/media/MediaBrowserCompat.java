...
import android.support.p001v4.media.MediaBrowserCompatApi24;
import android.support.p001v4.media.session.IMediaSession;
import android.support.p001v4.media.session.MediaSessionCompat;
import android.support.p001v4.p014os.ResultReceiver;
    ...
    private static class CallbackHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r9) {
            ...
            L_0x0016:
                ...
                java.lang.Class<android.support.v4.media.session.MediaSessionCompat> r4 = android.support.p001v4.media.session.MediaSessionCompat.class
                java.lang.ClassLoader r4 = r4.getClassLoader()
                r1.setClassLoader(r4)
                java.lang.ref.WeakReference<android.support.v4.media.MediaBrowserCompat$MediaBrowserServiceCallbackImpl> r4 = r8.mCallbackImplRef
                java.lang.Object r3 = r4.get()
                android.support.v4.media.MediaBrowserCompat$MediaBrowserServiceCallbackImpl r3 = (android.support.p001v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl) r3
                java.lang.ref.WeakReference<android.os.Messenger> r4 = r8.mCallbacksMessengerRef
                java.lang.Object r0 = r4.get()
                android.os.Messenger r0 = (android.os.Messenger) r0
                int r4 = r9.what     // Catch:{ BadParcelableException -> 0x006c }
                switch(r4) {
                    case 1: goto L_0x007e;
                    case 2: goto L_0x009a;
                    case 3: goto L_0x009f;
                    default: goto L_0x0038;
                }     // Catch:{ BadParcelableException -> 0x006c }
            L_0x0038:
                java.lang.String r4 = "MediaBrowserCompat"
                java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ BadParcelableException -> 0x006c }
                r5.<init>()     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r6 = "Unhandled message: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.StringBuilder r5 = r5.append(r9)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r6 = "\n  Client version: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x006c }
                r6 = 1
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r6 = "\n  Service version: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x006c }
                int r6 = r9.arg1     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r5 = r5.toString()     // Catch:{ BadParcelableException -> 0x006c }
                android.util.Log.w(r4, r5)     // Catch:{ BadParcelableException -> 0x006c }
                goto L_0x0015
            L_0x006c:
                r2 = move-exception
                java.lang.String r4 = "MediaBrowserCompat"
            ...
            L_0x007e:
                ...
                java.lang.String r5 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r4 = "data_media_session_token"
                android.os.Parcelable r4 = r1.getParcelable(r4)     // Catch:{ BadParcelableException -> 0x006c }
                android.support.v4.media.session.MediaSessionCompat$Token r4 = (android.support.p001v4.media.session.MediaSessionCompat.Token) r4     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r6 = "data_root_hints"
                android.os.Bundle r6 = r1.getBundle(r6)     // Catch:{ BadParcelableException -> 0x006c }
                r3.onServiceConnected(r0, r5, r4, r6)     // Catch:{ BadParcelableException -> 0x006c }
                goto L_0x0015
            L_0x009a:
                r3.onConnectionFailed(r0)     // Catch:{ BadParcelableException -> 0x006c }
                goto L_0x0015
            L_0x009f:
                java.lang.String r4 = "data_media_item_id"
                java.lang.String r4 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r5 = "data_media_item_list"
                java.util.ArrayList r5 = r1.getParcelableArrayList(r5)     // Catch:{ BadParcelableException -> 0x006c }
                java.lang.String r6 = "data_options"
                android.os.Bundle r6 = r1.getBundle(r6)     // Catch:{ BadParcelableException -> 0x006c }
                r3.onLoadChildren(r0, r4, r5, r6)     // Catch:{ BadParcelableException -> 0x006c }
                goto L_0x0015
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.media.MediaBrowserCompat.CallbackHandler.handleMessage(android.os.Message):void");
        }
