        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    sendCommand(_arg011, _arg19, _arg2);
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg010 = (KeyEvent) KeyEvent.CREATOR.createFromParcel(data);
                    } else {
                        _arg010 = null;
                    }
                    boolean _result = sendMediaButton(_arg010);
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 14:
                    ...
                    playFromMediaId(_arg012, _arg15);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 26:
                    ...
                    sendCustomAction(_arg014, _arg1);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(_arg015, _arg18);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(_arg016, _arg17);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 40:
                    ...
                    setShuffleModeEnabledDeprecated(_arg0);
                    reply.writeNoException();
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg09 = MediaDescriptionCompat.CREATOR.createFromParcel(data);
                    } else {
                        _arg09 = null;
                    }
                    addQueueItem(_arg09);
                ...
                case 42:
                    ...
                    addQueueItemAt(_arg08, data.readInt());
                    reply.writeNoException();
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
