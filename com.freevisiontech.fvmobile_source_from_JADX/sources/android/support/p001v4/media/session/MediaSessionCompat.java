...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v1, resolved type: android.support.v4.media.session.MediaSessionCompat$QueueItem} */
            ...
            public void onCommand(java.lang.String r10, android.os.Bundle r11, android.os.ResultReceiver r12) {
                /*
                    ...
                    boolean r6 = r10.equals(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r6 == 0) goto L_0x0037
                    android.support.v4.media.session.MediaSessionCompat$Callback r6 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x0058 }
                    java.lang.ref.WeakReference r6 = r6.mSessionImpl     // Catch:{ BadParcelableException -> 0x0058 }
                    java.lang.Object r2 = r6.get()     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r2 = (android.support.p001v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r2     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r2 == 0) goto L_0x0031
                    android.os.Bundle r5 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x0058 }
                    r5.<init>()     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.session.MediaSessionCompat$Token r6 = r2.getSessionToken()     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.session.IMediaSession r1 = r6.getExtraBinder()     // Catch:{ BadParcelableException -> 0x0058 }
                    java.lang.String r6 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r1 != 0) goto L_0x0032
                L_0x002a:
                    android.support.p001v4.app.BundleCompat.putBinder(r5, r6, r4)     // Catch:{ BadParcelableException -> 0x0058 }
                    r6 = 0
                    r12.send(r6, r5)     // Catch:{ BadParcelableException -> 0x0058 }
                L_0x0031:
                    return
                L_0x0032:
                    android.os.IBinder r4 = r1.asBinder()     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x002a
                L_0x0037:
                    java.lang.String r6 = "android.support.v4.media.session.command.ADD_QUEUE_ITEM"
                    boolean r6 = r10.equals(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r6 == 0) goto L_0x0063
                    java.lang.Class<android.support.v4.media.MediaDescriptionCompat> r6 = android.support.p001v4.media.MediaDescriptionCompat.class
                    java.lang.ClassLoader r6 = r6.getClassLoader()     // Catch:{ BadParcelableException -> 0x0058 }
                    r11.setClassLoader(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.session.MediaSessionCompat$Callback r7 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x0058 }
                    java.lang.String r6 = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"
                    android.os.Parcelable r6 = r11.getParcelable(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.MediaDescriptionCompat r6 = (android.support.p001v4.media.MediaDescriptionCompat) r6     // Catch:{ BadParcelableException -> 0x0058 }
                    r7.onAddQueueItem(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x0031
                L_0x0058:
                    r0 = move-exception
                ...
                L_0x0063:
                    ...
                    int r8 = r11.getInt(r8)     // Catch:{ BadParcelableException -> 0x0058 }
                    r7.onAddQueueItem(r6, r8)     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x0031
                L_0x008b:
                    ...
                    android.os.Parcelable r6 = r11.getParcelable(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.MediaDescriptionCompat r6 = (android.support.p001v4.media.MediaDescriptionCompat) r6     // Catch:{ BadParcelableException -> 0x0058 }
                    r7.onRemoveQueueItem(r6)     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x0031
                L_0x00ac:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r2 = (android.support.p001v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r2     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r2 == 0) goto L_0x0031
                    java.util.List r6 = r2.mQueue     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r6 == 0) goto L_0x0031
                    java.lang.String r6 = "android.support.v4.media.session.command.ARGUMENT_INDEX"
                    r7 = -1
                    int r3 = r11.getInt(r6, r7)     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r3 < 0) goto L_0x00e8
                    java.util.List r6 = r2.mQueue     // Catch:{ BadParcelableException -> 0x0058 }
                    int r6 = r6.size()     // Catch:{ BadParcelableException -> 0x0058 }
                    if (r3 >= r6) goto L_0x00e8
                    java.util.List r6 = r2.mQueue     // Catch:{ BadParcelableException -> 0x0058 }
                    java.lang.Object r6 = r6.get(r3)     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r6 = (android.support.p001v4.media.session.MediaSessionCompat.QueueItem) r6     // Catch:{ BadParcelableException -> 0x0058 }
                    r4 = r6
                L_0x00e8:
                    if (r4 == 0) goto L_0x0031
                    android.support.v4.media.session.MediaSessionCompat$Callback r6 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x0058 }
                    android.support.v4.media.MediaDescriptionCompat r7 = r4.getDescription()     // Catch:{ BadParcelableException -> 0x0058 }
                    r6.onRemoveQueueItem(r7)     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x0031
                L_0x00f5:
                    android.support.v4.media.session.MediaSessionCompat$Callback r6 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x0058 }
                    r6.onCommand(r10, r11, r12)     // Catch:{ BadParcelableException -> 0x0058 }
                    goto L_0x0031
                */
                throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.media.session.MediaSessionCompat.Callback.StubApi21.onCommand(java.lang.String, android.os.Bundle, android.os.ResultReceiver):void");
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private void sendShuffleModeEnabled(boolean enabled) {
            for (int i = this.mControllerCallbacks.beginBroadcast() - 1; i >= 0; i--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(i).onShuffleModeChangedDeprecated(enabled);
                } catch (RemoteException e) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setShuffleModeEnabled(boolean enabled) {
            if (this.mShuffleModeEnabled != enabled) {
                ...
                for (int i = this.mExtraControllerCallbacks.beginBroadcast() - 1; i >= 0; i--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(i).onShuffleModeChangedDeprecated(enabled);
                    } catch (RemoteException e) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
