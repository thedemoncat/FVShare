...
class DocumentsContractApi19 {
    ...
    public static long getFlags(Context context, Uri self) {
        return queryForLong(context, self, DownloaderServiceMarshaller.PARAMS_FLAGS, 0);
    }
    ...
    public static boolean canWrite(Context context, Uri self) {
        ...
        String type = getRawType(context, self);
        int flags = queryForInt(context, self, DownloaderServiceMarshaller.PARAMS_FLAGS, 0);
