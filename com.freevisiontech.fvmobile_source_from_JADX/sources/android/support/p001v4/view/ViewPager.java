    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!(child.getVisibility() == 8 || (lp2 = (LayoutParams) child.getLayoutParams()) == null || !lp2.isDecor)) {
                ...
                if (consumeVertical) {
                    widthMode = C1907C.ENCODING_PCM_32BIT;
                } else if (consumeHorizontal) {
                    heightMode = C1907C.ENCODING_PCM_32BIT;
                }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, C1907C.ENCODING_PCM_32BIT);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, C1907C.ENCODING_PCM_32BIT);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), C1907C.ENCODING_PCM_32BIT), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, C1907C.ENCODING_PCM_32BIT));
                    }
