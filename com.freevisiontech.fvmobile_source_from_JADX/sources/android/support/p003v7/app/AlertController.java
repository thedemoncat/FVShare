...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0777R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0777R.styleable.AlertDialog, C0777R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0777R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0777R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0777R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0777R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0777R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0777R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0777R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0777R.C0779id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0777R.C0779id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0777R.C0779id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0777R.C0779id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0777R.C0779id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0777R.C0779id.topPanel);
        View customContentPanel = customPanel.findViewById(C0777R.C0779id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0777R.C0779id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null || (spacer2 = contentPanel.findViewById(C0777R.C0779id.textSpacerNoButtons)) == null)) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0777R.C0779id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (!(contentPanel == null || (spacer = contentPanel.findViewById(C0777R.C0779id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0777R.C0779id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0777R.C0779id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0777R.C0779id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0777R.C0779id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0777R.C0779id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0777R.C0779id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0777R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0777R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0777R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public static class AlertParams {
        ...
        private void createListView(final android.support.p003v7.app.AlertController r11) {
            /*
                ...
                android.support.v7.app.AlertController$RecycleListView r6 = (android.support.p003v7.app.AlertController.RecycleListView) r6
