...
class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String name, AttributeSet attrs) {
        ...
        try {
            ...
            View view2 = createView(context, name, (String) null);
            this.mConstructorArgs[0] = null;
            this.mConstructorArgs[1] = null;
            return view2;
        } catch (Exception e) {
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, boolean useAndroidTheme, boolean useAppTheme) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0777R.styleable.View, 0, 0);
        int themeId = 0;
        if (useAndroidTheme) {
            themeId = a.getResourceId(C0777R.styleable.View_android_theme, 0);
        }
        if (useAppTheme && themeId == 0 && (themeId = a.getResourceId(C0777R.styleable.View_theme, 0)) != 0) {
