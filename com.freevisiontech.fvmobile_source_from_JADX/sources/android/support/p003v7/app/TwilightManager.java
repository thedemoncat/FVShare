...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - C0015a.f22i, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(C0015a.f22i + now, location.getLatitude(), location.getLongitude());
