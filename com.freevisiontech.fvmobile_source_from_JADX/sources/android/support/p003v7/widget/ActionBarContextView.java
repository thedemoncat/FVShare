...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0777R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0777R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0777R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0777R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0777R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0777R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0777R.styleable.ActionMode_closeItemLayout, C0777R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0777R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0777R.C0779id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0777R.C0779id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0777R.C0779id.action_mode_close_button).setOnClickListener(new View.OnClickListener() {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int customWidthMode = lp2.width != -2 ? C1907C.ENCODING_PCM_32BIT : Integer.MIN_VALUE;
                if (lp2.width >= 0) {
                    customWidth = Math.min(lp2.width, availableWidth);
                } else {
                    customWidth = availableWidth;
                }
                int customHeightMode = lp2.height != -2 ? C1907C.ENCODING_PCM_32BIT : Integer.MIN_VALUE;
                if (lp2.height >= 0) {
