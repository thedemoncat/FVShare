    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0777R.C0779id.topPanel) {
                    topPanel = child;
                } else if (id == C0777R.C0779id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0777R.C0779id.contentPanel && id != C0777R.C0779id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (buttonPanel != null) {
            ...
            buttonPanel.measure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(buttonHeight, C1907C.ENCODING_PCM_32BIT));
