    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tvw == null || tvw.type == 0)) {
                ...
                if (w > 0) {
                    widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), View.MeasureSpec.getSize(widthMeasureSpec)), C1907C.ENCODING_PCM_32BIT);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (!(tvh == null || tvh.type == 0)) {
                ...
                if (h > 0) {
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), View.MeasureSpec.getSize(heightMeasureSpec)), C1907C.ENCODING_PCM_32BIT);
                }
            }
        }
        ...
        int widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(width, C1907C.ENCODING_PCM_32BIT);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tv == null || tv.type == 0)) {
                ...
                if (width < min) {
                    widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(min, C1907C.ENCODING_PCM_32BIT);
                    measure = true;
                }
            }
        }
