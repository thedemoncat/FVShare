    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                measureChild(view3, C1907C.ENCODING_PCM_32BIT, true);
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    wSpec = getChildMeasureSpec(totalSpaceInOther, C1907C.ENCODING_PCM_32BIT, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, C1907C.ENCODING_PCM_32BIT);
                } else {
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, C1907C.ENCODING_PCM_32BIT);
                    hSpec = getChildMeasureSpec(totalSpaceInOther, C1907C.ENCODING_PCM_32BIT, verticalInsets, lp.height, false);
                }
