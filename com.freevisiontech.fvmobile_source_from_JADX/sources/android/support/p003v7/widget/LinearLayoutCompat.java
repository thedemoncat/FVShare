...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0777R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0777R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0777R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0777R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0777R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0777R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0777R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0777R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0777R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0777R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
                ...
                if (child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.height == 0 && heightMode == 1073741824) {
                            ...
                            child3.measure(childWidthMeasureSpec, View.MeasureSpec.makeMeasureSpec(share, C1907C.ENCODING_PCM_32BIT));
                        } else {
                            int childHeight2 = child3.getMeasuredHeight() + share;
                            if (childHeight2 < 0) {
                                childHeight2 = 0;
                            }
                            child3.measure(childWidthMeasureSpec, View.MeasureSpec.makeMeasureSpec(childHeight2, C1907C.ENCODING_PCM_32BIT));
                        }
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (int i4 = 0; i4 < count; i4++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(largestChildHeight, C1907C.ENCODING_PCM_32BIT));
                    }
                }
            }
        }
    ...
    private void forceUniformWidth(int count, int heightMeasureSpec) {
        int uniformMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C1907C.ENCODING_PCM_32BIT);
        for (int i = 0; i < count; i++) {
            View child = getVirtualChildAt(i);
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.width == 0 && widthMode == 1073741824) {
                            ...
                            child3.measure(View.MeasureSpec.makeMeasureSpec(share, C1907C.ENCODING_PCM_32BIT), childHeightMeasureSpec);
                        } else {
                            int childWidth2 = child3.getMeasuredWidth() + share;
                            if (childWidth2 < 0) {
                                childWidth2 = 0;
                            }
                            child3.measure(View.MeasureSpec.makeMeasureSpec(childWidth2, C1907C.ENCODING_PCM_32BIT), childHeightMeasureSpec);
                        }
                        childState = View.combineMeasuredStates(childState, child3.getMeasuredState() & -16777216);
                    }
                    if (isExactly) {
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (int i6 = 0; i6 < count; i6++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(View.MeasureSpec.makeMeasureSpec(largestChildWidth, C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(child4.getMeasuredHeight(), C1907C.ENCODING_PCM_32BIT));
                    }
                }
            }
        }
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        int uniformMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C1907C.ENCODING_PCM_32BIT);
        for (int i = 0; i < count; i++) {
            View child = getVirtualChildAt(i);
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0777R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0777R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0777R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
