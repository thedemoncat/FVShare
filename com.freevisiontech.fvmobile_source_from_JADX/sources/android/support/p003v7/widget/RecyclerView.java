...
import android.support.p001v4.p014os.TraceCompat;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0780R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0780R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0780R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0780R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0780R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0780R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0780R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0780R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private void createLayoutManager(android.content.Context r11, java.lang.String r12, android.util.AttributeSet r13, int r14, int r15) {
        ...
        L_0x001e:
            ...
            java.lang.Class<android.support.v7.widget.RecyclerView$LayoutManager> r8 = android.support.p003v7.widget.RecyclerView.LayoutManager.class
        ...
        L_0x0047:
            ...
            android.support.v7.widget.RecyclerView$LayoutManager r7 = (android.support.p003v7.widget.RecyclerView.LayoutManager) r7     // Catch:{ ClassNotFoundException -> 0x0089, InvocationTargetException -> 0x00ac, InstantiationException -> 0x00cf, IllegalAccessException -> 0x00f2, ClassCastException -> 0x0115 }
    ...
    private boolean isPreferredNextFocusAbsolute(View focused, View next, int direction) {
        ...
        switch (direction) {
            ...
            case 130:
                ...
                return false;
            default:
                throw new IllegalArgumentException("direction must be absolute. received:" + direction + exceptionLabel());
        }
    }
        ...
        if (this.mLayout == null) {
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C1907C.ENCODING_PCM_32BIT));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
    ...
    public static abstract class LayoutManager {
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = C1907C.ENCODING_PCM_32BIT;
            this.mHeightMode = C1907C.ENCODING_PCM_32BIT;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = C1907C.ENCODING_PCM_32BIT;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0780R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0780R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0780R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0780R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0780R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), C1907C.ENCODING_PCM_32BIT));
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0780R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0780R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0780R.dimen.fastscroll_margin));
    }
