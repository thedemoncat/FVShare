...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, C1907C.ENCODING_PCM_32BIT);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), (AttributeSet) null, C0777R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), (AttributeSet) null, C0777R.attr.actionDropDownStyle);
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean forList) {
            super(context, (AttributeSet) null, C0777R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, this.BG_ATTRS, C0777R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, C1907C.ENCODING_PCM_32BIT), heightMeasureSpec);
            }
        }
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), (AttributeSet) null, C0777R.attr.actionBarTabTextStyle);
