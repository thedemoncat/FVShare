...
public class TintTypedArray {
    ...
    public Typeface getFont(@StyleableRes int index, int style, @NonNull TextView targetView) {
        ...
        return ResourcesCompat.getFont(this.mContext, resourceId, this.mTypedValue, style, targetView);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0011, code lost:
        r1 = android.support.p003v7.content.res.AppCompatResources.getColorStateList(r4.mContext, (r0 = r4.mWrapped.getResourceId(r5, 0)));
     */
    ...
    public android.content.res.ColorStateList getColorStateList(int r5) {
        /*
            ...
            android.content.res.ColorStateList r1 = android.support.p003v7.content.res.AppCompatResources.getColorStateList(r2, r0)
        ...
        L_0x001a:
            ...
            goto L_0x0019
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.TintTypedArray.getColorStateList(int):android.content.res.ColorStateList");
    }
