...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        copy.measure(View.MeasureSpec.makeMeasureSpec(right - left, C1907C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(bottom - top, C1907C.ENCODING_PCM_32BIT));
