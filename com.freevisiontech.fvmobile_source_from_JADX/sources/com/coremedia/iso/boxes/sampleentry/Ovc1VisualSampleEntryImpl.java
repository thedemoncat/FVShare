...
public class Ovc1VisualSampleEntryImpl extends AbstractSampleEntry {
    ...
    public void setVc1Content(byte[] vc1Content2) {
        this.vc1Content = vc1Content2;
    }
    ...
    public long getSize() {
        return ((long) this.vc1Content.length) + ((long) ((this.largeBox || ((long) (this.vc1Content.length + 16)) >= IjkMediaMeta.AV_CH_WIDE_RIGHT) ? 16 : 8)) + 8;
    }
}
