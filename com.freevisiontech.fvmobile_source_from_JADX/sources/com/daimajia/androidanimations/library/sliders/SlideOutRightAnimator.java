...
public class SlideOutRightAnimator extends BaseViewAnimator {
    public void prepare(View target) {
        ...
        getAnimatorAgent().playTogether(new Animator[]{ObjectAnimator.ofFloat(target, "alpha", new float[]{1.0f, 0.0f}), ObjectAnimator.ofFloat(target, "translationX", new float[]{0.0f, (float) distance})});
    }
}
