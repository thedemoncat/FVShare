...
public class ZoomOutLeftAnimator extends BaseViewAnimator {
    ...
    public void prepare(View target) {
        getAnimatorAgent().playTogether(new Animator[]{ObjectAnimator.ofFloat(target, "alpha", new float[]{1.0f, 1.0f, 0.0f}), ObjectAnimator.ofFloat(target, "scaleX", new float[]{1.0f, 0.475f, 0.1f}), ObjectAnimator.ofFloat(target, "scaleY", new float[]{1.0f, 0.475f, 0.1f}), ObjectAnimator.ofFloat(target, "translationX", new float[]{0.0f, 42.0f, (float) (-target.getRight())})});
    }
}
