...
public class FilterAdjuster {
    ...
    public FilterAdjuster(GPUImageFilter filter) {
        ...
        } else if (filter instanceof GPUImageBeautyFilter) {
            this.adjuster = new BeautyAdjuster().filter(filter);
        } else {
            this.adjuster = null;
        }
    }
    ...
    private class BeautyAdjuster extends Adjuster<GPUImageBeautyFilter> {
        ...
        public void adjust(int percentage) {
            ...
            ((GPUImageBeautyFilter) getFilter()).setBeautyLevel(level);
        }
    }
}
