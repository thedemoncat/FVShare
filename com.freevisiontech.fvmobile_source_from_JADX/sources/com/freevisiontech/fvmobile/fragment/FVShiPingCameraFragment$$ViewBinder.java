...
public class FVShiPingCameraFragment$$ViewBinder<T extends FVShiPingCameraFragment> implements ButterKnife.ViewBinder<T> {
    public void bind(ButterKnife.Finder finder, T target, Object source) {
        ...
        target.fragment_file_shiping_none = (RelativeLayout) finder.castView((View) finder.findRequiredView(source, C0853R.C0855id.fragment_file_shiping_none, "field 'fragment_file_shiping_none'"), C0853R.C0855id.fragment_file_shiping_none, "field 'fragment_file_shiping_none'");
    }

    public void unbind(T target) {
        target.fragment_recycler_shiping = null;
        target.file_paint_to_activity = null;
        target.fragment_file_shiping_none = null;
    }
}
