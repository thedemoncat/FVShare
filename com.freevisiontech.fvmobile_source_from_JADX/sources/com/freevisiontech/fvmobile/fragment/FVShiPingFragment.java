...
public class FVShiPingFragment extends Fragment implements View.OnClickListener, OnDataChangeObserver {
            ...
            public void onBind(BaseViewHolder holder, int pos) {
                ...
                if (Util.isZh(this.mContext)) {
                    if (timeStamp.substring(0, 4).equals(((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(0, 4))) {
                        item_date_text_view.setText(((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(4, 6) + "月" + ((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(6, ((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().length()) + "日");
                    } else {
                        item_date_text_view.setText(((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(0, 4) + "年" + ((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(4, 6) + "月" + ((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().substring(6, ((FilePhotoModel.DateBean) FVShiPingFragment.this.listFileModel.get(pos)).getTime().length()) + "日");
                    }
    ...
    private void deleteData() {
        String basePath;
        Log.i("KBein", "FVShiPingFragment.run(): 删除 ---> " + Thread.currentThread().getName());
