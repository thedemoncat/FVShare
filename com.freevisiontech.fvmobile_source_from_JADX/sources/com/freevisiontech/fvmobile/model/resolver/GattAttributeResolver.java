...
public class GattAttributeResolver {
    ...
    /* renamed from: GN */
    public static final String f1099GN = "00001117-0000-1000-8000-00805f9b34fb";
    ...
    /* renamed from: IP */
    public static final String f1100IP = "00000009-0000-1000-8000-00805f9b34fb";
    ...
    public static String getAttributeName(String uuid, String fallback) {
        String name = sGattAttributesMap.get(uuid.toLowerCase(Locale.US));
    ...
    private static Map<String, String> populateGattAttributesMap() {
        ...
        map.put("00002902-0000-1000-8000-00805f9b34fb", "CLIENT_CHARACTERISTIC_CONFIG");
