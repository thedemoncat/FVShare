...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mSuffix = "%";
        this.mPrefix = "";
        this.default_text_color = Color.rgb(66, 145, CompanyIdentifierResolver.WITRON_TECHNOLOGY_LIMITED);
        this.default_reached_color = Color.rgb(66, 145, CompanyIdentifierResolver.WITRON_TECHNOLOGY_LIMITED);
        this.default_unreached_color = Color.rgb(CompanyIdentifierResolver.BEATS_ELECTRONICS, CompanyIdentifierResolver.BEATS_ELECTRONICS, CompanyIdentifierResolver.BEATS_ELECTRONICS);
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, C0853R.styleable.NumberProgressBar, defStyleAttr, 0);
