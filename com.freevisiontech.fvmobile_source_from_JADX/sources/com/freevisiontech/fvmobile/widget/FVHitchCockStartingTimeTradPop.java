...
public class FVHitchCockStartingTimeTradPop implements View.OnClickListener {
    ...
    private LinearLayout bg_hitch_cock_setting_time_trad_linear_time;
    ...
    Handler myHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 10:
                    FVHitchCockStartingTimeTradPop.this.setHorUiZero();
                    return;
                case 11:
                    FVHitchCockStartingTimeTradPop.this.setHorUiNinety();
                    return;
                case 12:
                    FVHitchCockStartingTimeTradPop.this.setHorUiZero180();
                    return;
                case 13:
                    FVHitchCockStartingTimeTradPop.this.setHorUiNinety270();
                    return;
                default:
                    return;
            }
    ...
    public void init(Context context2, View parentView2, boolean isBacked2) {
        ...
        this.view = LayoutInflater.from(context2).inflate(C0853R.layout.layout_hitch_cock_setting_time_trad_pop, (ViewGroup) null);
        ...
        this.layout_camera_shortcut_pop_horizontal_bottom.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (FVHitchCockStartingTimeTradPop.this.pop != null) {
                }
            }
        });
        ...
        this.bg_hitch_cock_setting_time_trad_linear_time = (LinearLayout) this.view.findViewById(C0853R.C0855id.bg_hitch_cock_setting_time_trad_linear_time);
        this.isConnected = ViseBluetooth.getInstance().isConnected();
        if (CameraUtils.getCurrentPageIndex() == 2) {
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    if (FVHitchCockStartingTimeTradPop.this.isConnected) {
                        int unused = FVHitchCockStartingTimeTradPop.this.stirPosition = 0;
                        if (FVHitchCockStartingTimeTradPop.this.stirPosition == 0) {
                            FVHitchCockStartingTimeTradPop.this.setBackgroundColorSelect(FVHitchCockStartingTimeTradPop.this.stirPosition);
                        }
                    }
                    int color = FVHitchCockStartingTimeTradPop.this.mContext.getResources().getColor(C0853R.color.yellow_18);
                    FVHitchCockStartingTimeTradPop.this.horizontalScaleScrollViewHitchCockStartingTime.setColor(FVHitchCockStartingTimeTradPop.this.mContext.getResources().getColor(C0853R.color.color_black4), FVHitchCockStartingTimeTradPop.this.mContext.getResources().getColor(C0853R.color.white));
                }
            }, 100);
        }
    }
    ...
    private class OrientationBroadPopup extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (orientation == 0) {
                FVHitchCockStartingTimeTradPop.this.sendToHandler(10);
            } else if (orientation == 90) {
                FVHitchCockStartingTimeTradPop.this.sendToHandler(11);
            } else if (orientation == 180) {
                FVHitchCockStartingTimeTradPop.this.sendToHandler(12);
            } else if (orientation == 270) {
                FVHitchCockStartingTimeTradPop.this.sendToHandler(13);
            }
        }
    }
    ...
    private void initListener() {
        ...
        this.horizontalScaleScrollViewHitchCockStartingTime.setOnScrollListener(new BaseScaleViewHitchCockStartingTime.OnScrollListener() {
            public void onScaleScroll(int scale) {
                ...
                FVHitchCockStartingTimeTradPop.this.curScrollScaleWT = (int) sca;
                CameraUtils.setHitchCockVideoTime(((int) (sca / 10.0d)) + 2);
            }
        });
        new Handler().postDelayed(new Runnable() {
            public void run() {
                FVHitchCockStartingTimeTradPop.this.horizontalScaleScrollViewHitchCockStartingTime.setCurScale(0);
            }
        }, 200);
    }
    ...
    public void onModeSwitch(FVModeSelectEvent fvModeSelectEvent) {
        switch (fvModeSelectEvent.getMode()) {
            ...
            case Constants.LABEL_CAMERA_STIR_UP_210:
                if (CameraUtils.getFrameLayerNumber() == 36 && this.pop != null) {
                    Log.e("-----------------", "----------  7777  8888  9999   -------  210 波轮拨动向上   向上   向上    FVHitchCockStartingTimeTradPop  ");
                    if (!this.scaleSlide) {
                        this.stirPosition--;
            ...
            case Constants.LABEL_CAMERA_STIR_DOWN_210:
                if (CameraUtils.getFrameLayerNumber() == 36 && this.pop != null) {
                    Log.e("-----------------", "----------  7777  8888  9999   -------  波轮拨动向下   向下   向下    FVHitchCockStartingTimeTradPop  ");
                    if (!this.scaleSlide) {
                        this.stirPosition++;
            ...
            case Constants.LABEL_CAMERA_TOP_BAR_UP_OR_DOWN_210:
                ...
                if (this.stirPosition == 1) {
                    this.scaleSlide = false;
                    hitchCockStartingTimeTradPopNextClick();
                    return;
                }
                return;
            case Constants.LABEL_CAMERA_RETURN_KEY_210:
                Log.e("-----------------", "----------  7777  8888  9999   -------  FVHitchCockStartPlacePop");
                if (CameraUtils.getFrameLayerNumber() == 36) {
                    hitchCockStartingTimeTradPopReturnClick();
                    return;
                }
                return;
    ...
    private void hitchCockStartingTimeTradPopReturnClick() {
        if (this.pop != null) {
            this.pop.dismiss();
        }
        EventBus.getDefault().unregister(this);
    ...
    private void hitchCockStartingTimeTradPopNextClick() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                if (FVHitchCockStartingTimeTradPop.this.cameraManager != null && FVHitchCockStartingTimeTradPop.this.cameraManager.isMediaRecording()) {
                    Boolean connected = true;
                    FVHitchCockStartingTimeTradPop.this.cameraManager.stopMediaRecord();
                    ...
                    new Handler().postDelayed(new Runnable() {
                        public void run() {
                            FVHitchCockStartingTimeTradPop.this.cameraManager.setZoom(1.0f);
                        }
                    }, 200);
                    CameraUtils.setFrameLayerNumber(0);
                }
    ...
    public void setPop(PopupWindow pop3, final FVHitchCockStartingTimeTradPop hitchCockStartingTimePop) {
        this.pop = pop3;
        if (pop3 != null) {
            pop3.setOnDismissListener(new PopupWindow.OnDismissListener() {
                public void onDismiss() {
                    FVHitchCockStartingTimeTradPop.this.context.unregisterReceiver(FVHitchCockStartingTimeTradPop.this.broad);
                    EventBus.getDefault().unregister(hitchCockStartingTimePop);
                    Util.sendIntEventMessge(Constants.CAMERA_INDICATE_HIDDEN);
                    SPUtils.put(FVHitchCockStartingTimeTradPop.this.context, SharePrefConstant.POP_SHOW_OUTSIDE_CLICK_INTERCEPTOR, false);
                }
            });
        }
        CameraUtils.setFrameLayerNumber(36);
    }
    ...
    private void showHitchCockEndPlaceLegacyPop() {
        ...
        FVHitchCockEndPlaceLegacyPop hitchCockPop = new FVHitchCockEndPlaceLegacyPop();
