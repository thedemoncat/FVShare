...
public class SelfDialogKnow extends Dialog {
    ...
    public SelfDialogKnow(Context context) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0853R.layout.upgrade_dialog_i_know);
        initView();
    }
    ...
    private void initView() {
        ...
        this.finish.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SelfDialogKnow.this.buttonListener.onClick(v);
            }
        });
    }
