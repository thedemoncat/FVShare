...
public abstract class BaseScaleViewEV extends View {
    ...
    public BaseScaleViewEV(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewEV(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewEV(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewEV(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, Util.getDrawScaleEVMax());
