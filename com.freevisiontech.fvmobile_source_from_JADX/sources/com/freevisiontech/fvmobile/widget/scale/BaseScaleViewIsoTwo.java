...
public abstract class BaseScaleViewIsoTwo extends View {
    ...
    public BaseScaleViewIsoTwo(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewIsoTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewIsoTwo(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewIsoTwo(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, CameraUtils.getScaleIsoList().size() * 10);
