...
public abstract class BaseScaleViewMf extends View {
    ...
    public BaseScaleViewMf(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewMf(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewMf(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewMf(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (((Integer) SPUtils.get(getContext(), SharePrefConstant.CAMERA_LENS_MODE, Integer.valueOf(Constants.LENS_BLACK_MODE))).intValue() == 10101) {
            this.mMax = ta.getInteger(1, 1);
        } else {
            this.mMax = ta.getInteger(1, Util.getDrawScaleMFMax());
        }
