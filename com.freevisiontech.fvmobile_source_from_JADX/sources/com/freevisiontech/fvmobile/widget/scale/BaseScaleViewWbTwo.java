...
public abstract class BaseScaleViewWbTwo extends View {
    ...
    public BaseScaleViewWbTwo(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewWbTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewWbTwo(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewWbTwo(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, Util.getDrawScaleWBMax());
    ...
    public void setCurScale(int val) {
        if (val >= this.mMin && val <= this.mMax) {
            Log.e("------------", "----------  6666 mMidCountScale  WB  -------  : " + this.mMidCountScale);
            scrollToScale(val);
            postInvalidate();
        }
    }
