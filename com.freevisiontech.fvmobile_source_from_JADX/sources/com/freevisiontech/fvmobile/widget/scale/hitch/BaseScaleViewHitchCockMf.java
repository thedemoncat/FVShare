...
public abstract class BaseScaleViewHitchCockMf extends View {
    ...
    public BaseScaleViewHitchCockMf(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewHitchCockMf(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewHitchCockMf(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewHitchCockMf(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
