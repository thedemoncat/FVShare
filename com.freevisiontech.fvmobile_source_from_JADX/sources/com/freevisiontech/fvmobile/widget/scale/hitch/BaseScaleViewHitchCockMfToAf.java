...
public abstract class BaseScaleViewHitchCockMfToAf extends View {
    ...
    public BaseScaleViewHitchCockMfToAf(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewHitchCockMfToAf(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewHitchCockMfToAf(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewHitchCockMfToAf(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, Util.getDrawScaleMFMax() - 10);
        this.mScaleMargin = ta.getDimensionPixelOffset(2, 12);
