...
public abstract class BaseScaleViewHitchCockStartingTime extends View {
    ...
    public BaseScaleViewHitchCockStartingTime(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewHitchCockStartingTime(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewHitchCockStartingTime(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewHitchCockStartingTime(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, 580);
        this.mScaleMargin = ta.getDimensionPixelOffset(2, 10);
