...
public abstract class BaseScaleViewHitchCockTradWT extends View {
    ...
    public BaseScaleViewHitchCockTradWT(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewHitchCockTradWT(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewHitchCockTradWT(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewHitchCockTradWT(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        this.mMax = ta.getInteger(1, Util.getDrawScaleWTMax() * 2);
