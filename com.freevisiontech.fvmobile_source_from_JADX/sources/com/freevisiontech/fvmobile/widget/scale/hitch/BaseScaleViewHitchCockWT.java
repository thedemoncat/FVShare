...
public abstract class BaseScaleViewHitchCockWT extends View {
    ...
    public BaseScaleViewHitchCockWT(Context context) {
        super(context);
        init((AttributeSet) null);
    }

    public BaseScaleViewHitchCockWT(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseScaleViewHitchCockWT(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(21)
    public BaseScaleViewHitchCockWT(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
