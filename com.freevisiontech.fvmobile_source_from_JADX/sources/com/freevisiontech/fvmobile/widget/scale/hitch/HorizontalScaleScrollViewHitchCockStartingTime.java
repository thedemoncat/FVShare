...
public class HorizontalScaleScrollViewHitchCockStartingTime extends BaseScaleViewHitchCockStartingTime {
    ...
    public HorizontalScaleScrollViewHitchCockStartingTime(Context context) {
        super(context);
    }

    public HorizontalScaleScrollViewHitchCockStartingTime(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalScaleScrollViewHitchCockStartingTime(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public HorizontalScaleScrollViewHitchCockStartingTime(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        for (int i = 0; i <= this.mMax - this.mMin; i++) {
            if (i % 10 == 0) {
                ...
                if ("0.0".equals(String.valueOf(k2 / 10.0f))) {
                    ...
                    canvas.drawText(String.valueOf(((int) (k2 / 10.0f)) + 2), (float) (this.mScaleMargin * i), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                } else {
                    paint.setColor(this.mEndColor);
                    canvas.drawText(String.valueOf(((int) (k2 / 10.0f)) + 2), (float) (this.mScaleMargin * i), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                }
    ...
    public void onDrawPointer(Canvas canvas, Paint paint) {
        ...
        if (this.mScrollListener != null) {
            ...
            if (this.mCountScale % 10 == 0) {
                paint.setColor(this.mStartColor);
                if ("0.0".equals(String.valueOf(k2 / 10.0f))) {
                    canvas.drawText(String.valueOf(((int) (k2 / 10.0f)) + 2), (float) (this.mCountScale * this.mScaleMargin), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                } else {
                    canvas.drawText(String.valueOf(((int) (k2 / 10.0f)) + 2), (float) (this.mCountScale * this.mScaleMargin), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                }
        ...
        switch (event.getAction()) {
            ...
            case 1:
                ...
                if (this.mCountScale < 0) {
                    this.mCountScale = 0;
                } else if (this.mCountScale > 580) {
                    this.mCountScale = 580;
                }
