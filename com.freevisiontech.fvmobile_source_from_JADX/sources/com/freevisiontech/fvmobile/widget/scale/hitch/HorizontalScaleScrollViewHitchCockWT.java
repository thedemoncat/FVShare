...
public class HorizontalScaleScrollViewHitchCockWT extends BaseScaleViewHitchCockWT {
    ...
    public HorizontalScaleScrollViewHitchCockWT(Context context) {
        super(context);
    }

    public HorizontalScaleScrollViewHitchCockWT(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalScaleScrollViewHitchCockWT(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public HorizontalScaleScrollViewHitchCockWT(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        for (int i = 0; i <= this.mMax - this.mMin; i++) {
            if (i % 10 == 0) {
                ...
                if ("0.0".equals(String.valueOf(k2 / 10.0f))) {
                    ...
                    canvas.drawText(String.valueOf(((k2 / 10.0f) / 2.0f) + 1.0f), (float) (this.mScaleMargin * i), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                } else {
                    paint.setColor(this.mEndColor);
                    canvas.drawText(String.valueOf(((k2 / 10.0f) / 2.0f) + 1.0f), (float) (this.mScaleMargin * i), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                }
    ...
    public void onDrawPointer(Canvas canvas, Paint paint) {
        ...
        if (this.mScrollListener != null) {
            ...
            if (this.mCountScale % 10 == 0) {
                paint.setColor(this.mStartColor);
                if ("0.0".equals(String.valueOf(k2 / 10.0f))) {
                    canvas.drawText(String.valueOf(((k2 / 10.0f) / 2.0f) + 1.0f), (float) (this.mCountScale * this.mScaleMargin), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                } else {
                    canvas.drawText(String.valueOf(((k2 / 10.0f) / 2.0f) + 1.0f), (float) (this.mCountScale * this.mScaleMargin), (float) ((this.mRectHeight - this.mScaleMaxHeight) - 20), paint);
                }
