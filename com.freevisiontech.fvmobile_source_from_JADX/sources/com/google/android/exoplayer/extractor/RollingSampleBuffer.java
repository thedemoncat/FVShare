...
final class RollingSampleBuffer {
    ...
    private void readEncryptionData(SampleHolder sampleHolder, SampleExtrasHolder extrasHolder2) {
        ...
        if (sampleHolder.cryptoInfo.f1191iv == null) {
            sampleHolder.cryptoInfo.f1191iv = new byte[16];
        }
        readData(offset2, sampleHolder.cryptoInfo.f1191iv, ivSize);
        ...
        sampleHolder.cryptoInfo.set(subsampleCount, clearDataSizes, encryptedDataSizes, extrasHolder2.encryptionKeyId, sampleHolder.cryptoInfo.f1191iv, 1);
