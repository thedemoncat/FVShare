...
abstract class Atom {
    ...
    public static final int TYPE_data = Util.getIntegerCodeForString(CacheEntity.DATA);
    ...
    public static final int TYPE_name = Util.getIntegerCodeForString(SerializableCookie.NAME);
