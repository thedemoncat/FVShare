...
public class SampleImpl implements Sample {
    ...
    public SampleImpl(ByteBuffer[] data2) {
        this.offset = -1;
        int _size = 0;
        for (ByteBuffer byteBuffer : data2) {
    ...
    public SampleImpl(long offset2, long sampleSize, ByteBuffer data2) {
        this.offset = offset2;
        this.size = sampleSize;
        this.data = new ByteBuffer[]{data2};
        this.parent = null;
    }

    public SampleImpl(long offset2, long sampleSize, Container parent2) {
        this.offset = offset2;
        this.size = sampleSize;
        this.data = null;
        this.parent = parent2;
