...
public class SequenceParameterSetRbsp {
    public SequenceParameterSetRbsp(InputStream is) throws IOException {
        ...
        int j = (sps_max_sub_layers_minus1 - i) + 1;
        ...
        if (sps_sub_layer_ordering_info_present_flag) {
            ...
            i2 = sps_max_sub_layers_minus1;
        }
        while (i2 <= sps_max_sub_layers_minus1) {
            sps_max_dec_pic_buffering_minus1[i2] = bsr.readUE("sps_max_dec_pic_buffering_minus1[" + i2 + "]");
            sps_max_num_reorder_pics[i2] = bsr.readUE("sps_max_num_reorder_pics[" + i2 + "]");
            sps_max_latency_increase_plus1[i2] = bsr.readUE("sps_max_latency_increase_plus1[" + i2 + "]");
            i2++;
        }
