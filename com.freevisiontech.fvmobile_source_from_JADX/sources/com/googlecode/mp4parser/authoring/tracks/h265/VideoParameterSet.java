...
public class VideoParameterSet {
    ...
    public VideoParameterSet(ByteBuffer vps2) throws IOException {
        int i;
        this.vps = vps2;
        CAVLCReader r = new CAVLCReader(Channels.newInputStream(new ByteBufferByteChannel((ByteBuffer) vps2.position(0))));
