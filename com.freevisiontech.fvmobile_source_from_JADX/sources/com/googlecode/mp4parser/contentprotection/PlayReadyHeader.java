...
public class PlayReadyHeader extends ProtectionSpecificHeader {
    ...
    public void setRecords(List<PlayReadyRecord> records2) {
    ...
    public static abstract class PlayReadyRecord {
        ...
        public PlayReadyRecord(int type2) {
            this.type = type2;
        }
        ...
        public static List<PlayReadyRecord> createFor(ByteBuffer byteBuffer, int recordCount) {
            ...
            for (int i = 0; i < recordCount; i++) {
                int type2 = IsoTypeReader.readUInt16BE(byteBuffer);
                ...
                switch (type2) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        record = new DefaulPlayReadyRecord(type2);
                        break;
                }
