...
public class BitstreamWriter {
    ...
    /* renamed from: os */
    private final OutputStream f1037os;
    ...
    private void writeCurByte() throws IOException {
        this.f1037os.write((this.curByte[0] << 7) | (this.curByte[1] << 6) | (this.curByte[2] << 5) | (this.curByte[3] << 4) | (this.curByte[4] << 3) | (this.curByte[5] << 2) | (this.curByte[6] << 1) | this.curByte[7]);
    }
