...
public class AvcDecoderConfigurationRecord {
    ...
    public AvcDecoderConfigurationRecord(ByteBuffer content) {
        ...
        for (int i2 = 0; ((long) i2) < numberOfPictureParameterSets; i2++) {
        ...
        for (int i3 = 0; ((long) i3) < numOfSequenceParameterSetExt; i3++) {
    ...
    public String[] getSPS() {
        ...
        for (byte[] sequenceParameterSet : this.sequenceParameterSets) {
            ...
            try {
                detail = SeqParameterSet.read((InputStream) new CleanInputStream(new ByteArrayInputStream(sequenceParameterSet, 1, sequenceParameterSet.length - 1))).toString();
            } catch (IOException e) {
            }
            l.add(detail);
        }
