...
public class TemporalLayerSampleGroup extends GroupEntry {
    ...
    public void setTemporalLayerId(int temporalLayerId2) {
        this.temporalLayerId = temporalLayerId2;
    }
    ...
    public void setTlprofile_space(int tlprofile_space2) {
        this.tlprofile_space = tlprofile_space2;
    }
    ...
    public void setTltier_flag(boolean tltier_flag2) {
        this.tltier_flag = tltier_flag2;
    }
    ...
    public void setTlprofile_idc(int tlprofile_idc2) {
        this.tlprofile_idc = tlprofile_idc2;
    }
    ...
    public void setTlprofile_compatibility_flags(long tlprofile_compatibility_flags2) {
        this.tlprofile_compatibility_flags = tlprofile_compatibility_flags2;
    }
    ...
    public void setTlconstraint_indicator_flags(long tlconstraint_indicator_flags2) {
        this.tlconstraint_indicator_flags = tlconstraint_indicator_flags2;
    }
    ...
    public void setTllevel_idc(int tllevel_idc2) {
        this.tllevel_idc = tllevel_idc2;
    }
    ...
    public void setTlMaxBitRate(int tlMaxBitRate2) {
        this.tlMaxBitRate = tlMaxBitRate2;
    }
    ...
    public void setTlAvgBitRate(int tlAvgBitRate2) {
        this.tlAvgBitRate = tlAvgBitRate2;
    }
    ...
    public void setTlConstantFrameRate(int tlConstantFrameRate2) {
        this.tlConstantFrameRate = tlConstantFrameRate2;
    }
    ...
    public void setTlAvgFrameRate(int tlAvgFrameRate2) {
        this.tlAvgFrameRate = tlAvgFrameRate2;
    }

    public void parse(ByteBuffer byteBuffer) {
        this.temporalLayerId = IsoTypeReader.readUInt8(byteBuffer);
        int a = IsoTypeReader.readUInt8(byteBuffer);
        this.tlprofile_space = (a & 192) >> 6;
