        ...
        while (it.hasNext()) {
            ...
            if (cloneListeners != null) {
                ...
                if (listenersToRemove != null) {
                    ...
                    while (i$2.hasNext()) {
                        cloneListeners.remove(i$2.next());
                    }
                }
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (node2.dependencies != null) {
                ...
                while (i$3.hasNext()) {
                    ...
                    nodeClone2.addDependency(new Dependency(nodeCloneMap.get(dependency.node), dependency.rule));
                }
            }
        }
        return anim;
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (!AnimatorSet.this.mTerminated) {
                ...
                while (true) {
                    if (i >= numSortedNodes) {
                        break;
                    } else if (!sortedNodes.get(i).done) {
                        allDone = false;
                        break;
                    } else {
                        i++;
