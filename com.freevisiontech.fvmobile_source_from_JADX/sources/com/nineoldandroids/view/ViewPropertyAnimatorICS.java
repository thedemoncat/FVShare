...
class ViewPropertyAnimatorICS extends ViewPropertyAnimator {
    ...
    public ViewPropertyAnimator setListener(final Animator.AnimatorListener listener) {
        ...
        if (n != null) {
            if (listener == null) {
                n.setListener((Animator.AnimatorListener) null);
            } else {
                n.setListener(new Animator.AnimatorListener() {
                    public void onAnimationStart(android.animation.Animator animation) {
                        listener.onAnimationStart((com.nineoldandroids.animation.Animator) null);
                    }

                    public void onAnimationRepeat(android.animation.Animator animation) {
                        listener.onAnimationRepeat((com.nineoldandroids.animation.Animator) null);
                    }

                    public void onAnimationEnd(android.animation.Animator animation) {
                        listener.onAnimationEnd((com.nineoldandroids.animation.Animator) null);
                    }

                    public void onAnimationCancel(android.animation.Animator animation) {
                        listener.onAnimationCancel((com.nineoldandroids.animation.Animator) null);
                    }
                });
            }
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimator mo14703x(float value) {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        if (n != null) {
            n.x(value);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimator mo14705y(float value) {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        if (n != null) {
            n.y(value);
        }
