...
import okhttp3.internal.p005io.FileSystem;
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink sink, List<Certificate> certificates) throws IOException {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    sink.writeUtf8(ByteString.m1459of(certificates.get(i).getEncoded()).base64()).writeByte(10);
                }
        ...
        public Response response(DiskLruCache.Snapshot snapshot) {
            String contentType = this.responseHeaders.get(com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_TYPE);
            String contentLength = this.responseHeaders.get(com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_LENGTH);
