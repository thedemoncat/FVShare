...
public final class CertificatePinner {
    ...
    static ByteString sha1(X509Certificate x509Certificate) {
        return ByteString.m1459of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    static ByteString sha256(X509Certificate x509Certificate) {
        return ByteString.m1459of(x509Certificate.getPublicKey().getEncoded()).sha256();
    }
    ...
    static final class Pin {
        ...
        Pin(String pattern2, String pin) {
            ...
            if (pattern2.startsWith(WILDCARD)) {
                host = HttpUrl.parse("http://" + pattern2.substring(WILDCARD.length())).host();
            } else {
                host = HttpUrl.parse("http://" + pattern2).host();
            }
