...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers cachedHeaders, Headers networkHeaders) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(fieldName) || !value.startsWith(BleConstant.SHUTTER)) && (!isEndToEnd(fieldName) || networkHeaders.get(fieldName) == null)) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (!com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_LENGTH.equalsIgnoreCase(fieldName2) && isEndToEnd(fieldName2)) {
