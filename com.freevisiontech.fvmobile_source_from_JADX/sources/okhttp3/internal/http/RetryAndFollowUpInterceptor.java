...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        while (!this.canceled) {
            try {
                Response response = ((RealInterceptorChain) chain).proceed(request, this.streamAllocation, (HttpCodec) null, (RealConnection) null);
                if (0 != 0) {
    ...
    private Request followUpRequest(Response userResponse) throws IOException {
        ...
        switch (responseCode) {
            case 300:
            case CompanyIdentifierResolver.SONY_CORPORATION /*301*/:
            case CompanyIdentifierResolver.ASSA_ABLOY /*302*/:
            case CompanyIdentifierResolver.CLARION_CO_LTD /*303*/:
                break;
            case 307:
            case 308:
        ...
        if (!this.client.followRedirects() || (location = userResponse.header(HttpHeaders.HEAD_KEY_LOCATION)) == null || (url = userResponse.request().url().resolve(location)) == null) {
            return null;
        }
        ...
        if (HttpMethod.permitsRequestBody(method)) {
            ...
            if (!maintainBody) {
                ...
                requestBuilder.removeHeader(HttpHeaders.HEAD_KEY_CONTENT_TYPE);
            }
        }
