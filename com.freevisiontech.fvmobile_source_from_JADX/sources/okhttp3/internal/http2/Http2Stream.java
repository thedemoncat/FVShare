...
public final class Http2Stream {
    ...
    public void sendResponseHeaders(List<Header> responseHeaders2, boolean out) throws IOException {
        if (!$assertionsDisabled && Thread.holdsLock(this)) {
            ...
            this.connection.writeSynReply(this.f1066id, outFinished, responseHeaders2);
            if (outFinished) {
    ...
    public void close(ErrorCode rstStatusCode) throws IOException {
        if (closeInternal(rstStatusCode)) {
            this.connection.writeSynReset(this.f1066id, rstStatusCode);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f1066id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        if ($assertionsDisabled || !Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                this.connection.removeStream(this.f1066id);
                return true;
            }
        }
        throw new AssertionError();
            ...
            synchronized (Http2Stream.this) {
                ...
                if (this.readBuffer.size() == 0) {
                    ...
                    if (Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                        Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f1066id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean outFinished) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f1066id, outFinished && toWrite == this.sendBuffer.size(), this.sendBuffer, toWrite);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x0042, code lost:
            r6.this$0.connection.writeData(r6.this$0.f1066id, true, (okio.Buffer) null, 0);
         */
