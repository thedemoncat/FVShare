...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f1067dn;
    private int end;
    private final int length = this.f1067dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal principal) {
        this.f1067dn = principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f1067dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f1067dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f1067dn.toCharArray();
