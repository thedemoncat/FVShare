...
public class PointcutImpl implements Pointcut {
    ...
    /* renamed from: pc */
    private final PointcutExpression f1051pc;

    protected PointcutImpl(String name2, String pc, Method method, AjType declaringType2, String pNames) {
        this.name = name2;
        this.f1051pc = new PointcutExpressionImpl(pc);
