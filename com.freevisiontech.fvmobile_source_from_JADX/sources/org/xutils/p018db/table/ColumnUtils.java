...
public final class ColumnUtils {
    ...
    public static Object convert2DbValueIfNeeded(Object value) {
        Object result = value;
        if (value != null) {
            return ColumnConverterFactory.getColumnConverter(value.getClass()).fieldValue2DbValue(value);
        }
        return result;
    }
    ...
    static Method findGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                LogUtil.m1562d(entityType.getName() + "#" + methodName + " not exist");
            }
        }
        if (getMethod == null) {
    ...
    static Method findSetMethod(Class<?> entityType, Field field) {
        ...
        if (setMethod == null) {
            ...
            try {
                setMethod = entityType.getDeclaredMethod(methodName, new Class[]{fieldType});
            } catch (NoSuchMethodException e) {
                LogUtil.m1562d(entityType.getName() + "#" + methodName + " not exist");
            }
        }
    ...
    private static Method findBooleanSetMethod(Class<?> entityType, String fieldName, Class<?> fieldType) {
        ...
        try {
            return entityType.getDeclaredMethod(methodName, new Class[]{fieldType});
        } catch (NoSuchMethodException e) {
            LogUtil.m1562d(entityType.getName() + "#" + methodName + " not exist");
            return null;
        }
