...
/* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer */
public interface IMediaPlayer {
    ...
    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnBufferingUpdateListener */
    public interface OnBufferingUpdateListener {
        void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnCompletionListener */
    public interface OnCompletionListener {
        void onCompletion(IMediaPlayer iMediaPlayer);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnErrorListener */
    public interface OnErrorListener {
        boolean onError(IMediaPlayer iMediaPlayer, int i, int i2);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnInfoListener */
    public interface OnInfoListener {
        boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i2);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnPreparedListener */
    public interface OnPreparedListener {
        void onPrepared(IMediaPlayer iMediaPlayer);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnSeekCompleteListener */
    public interface OnSeekCompleteListener {
        void onSeekComplete(IMediaPlayer iMediaPlayer);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnTimedTextListener */
    public interface OnTimedTextListener {
        void onTimedText(IMediaPlayer iMediaPlayer, IjkTimedText ijkTimedText);
    }

    /* renamed from: tv.danmaku.ijk.media.player.IMediaPlayer$OnVideoSizeChangedListener */
